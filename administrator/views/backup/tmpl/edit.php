...
<script type="text/javascript">
    ...
    {
        if(task == 'backup.cancel'){
            Joomla.submitform(task, document.getElementById('backup-form'));
        }
        else{
            
            if (task != 'backup.cancel' && document.formvalidator.isValid(document.id('backup-form'))) {
                Joomla.submitform(task, document.getElementById('backup-form'));
            }
            else {
...
<form action="<?php echo JRoute::_('index.php?option=com_smart_backup&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="backup-form" class="form-validate">
    <div class="row-fluid">
        <div class="span10 form-horizontal">
			...
			<div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('bucket_key'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('bucket_key'); ?></div>
			</div>
